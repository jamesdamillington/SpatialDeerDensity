...
library(viridis)
#setwd("/Users/bowenzhang/Downloads/MichiganData")
DistanceLC <- raster("data/LOI200_dlc_km.asc")      #to create the raster object simply provide file name
...
```{r}
LandCov <- raster("data/covtyp_rc.asc")             #simply provide file name
...
```{r}
hdwd <- raster("data/covtyp_rc.asc")   #create a raster named hdwd
